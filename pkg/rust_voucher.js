...
* @returns {Array<any>}
*/
export function generate(pattern, count, char_set_number_enabled, char_set_symbol_enabled, char_set_uppercase_enabled, char_set_lowercase_enabled) {
    var ptr0 = passStringToWasm0(pattern, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    var len0 = WASM_VECTOR_LEN;
    var ret = wasm.generate(ptr0, len0, count, char_set_number_enabled, char_set_symbol_enabled, char_set_uppercase_enabled, char_set_lowercase_enabled);
...
async function init(input) {
    if (typeof input === 'undefined') {
        input = new URL('rust_voucher_bg.wasm', import.meta.url);
    }
    const imports = {};
    imports.wbg = {};
